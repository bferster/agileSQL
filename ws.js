...
/* 	NODEJS SQLITE API ///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	server: cd /opt/bitnami/wordpress/sql | forever stop ws.js | forever start ws.js 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  */
	...
	app.listen(3000, () => {
		...
		app.get("/sql/paGetByEmail", (req, res, next) => {								// ON GET BY EMAIL
		...
		app.get("/sql/paGetById", (req, res, next) => {									// ON GET BY ID
